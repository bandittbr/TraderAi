...
export default function CockpitPage() {
  ...
  const systemStatus: "online" | "degraded" | "offline" = health.backend === "online" ? "online" : "offline";
  ...
  return (
    <div className="min-h-screen" style={{ background: "#050816" }}>
      <div className="max-w-[1600px] mx-auto px-4 py-4 space-y-4">
        ...
        {/* ── Footer ─────────────────────────────────────────────────────── */}
        <footer className="pt-3 pb-4 border-t border-[#1a2540] text-center">
          <div className="flex items-center justify-center gap-4 text-[9px] font-mono text-[#1e2e45]">
            <span>TRADEAI COCKPIT v14.0.0</span>
            <span className="w-px h-3 bg-[#1a2540]" />
